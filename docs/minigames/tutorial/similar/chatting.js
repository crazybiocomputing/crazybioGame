var dialog = {
  ...
  '00A' : {
    ...
    'people'     : 'boy',
    'html'     :
    'A partir de l\'échantillon A, on va chercher de quel animal, cette séquence du gène COI provient...</p>__button__',
    'widgets': [
      {
        'event'   : 'onclick',
        'type'    : 'button',
  ...
  '00C' : {
    ...
    'people'     : 'boy',
    'html'     :
    '<p>... On utilise un outil bioinformatique BLAST qui découpe la séquence inconnue en mots de 11 caractères de long puis qui recherche ces mots dans chacune des séquences de la banque de la même façon qu\'on recherche dans un dictionnaire...</p>__button__',
    'widgets': [
      {
        'event'   : 'onclick',
        'type'    : 'button',
  ...
  '107' : {
    ...
    'people'     : 'boy',
    'html'     :
    '<p>... J\'ai reçu les trois autres séquences de Clara et j\'ai lancé un BLAST pour en trouver l\'origine: (B) <b>Panthera pardus</b>, (C) <b>Oryctolagus cuniculus</b>, (D) <b>Mus musculus</b></p> __button__',
    'widgets': [
      {
        'event'   : 'onclick',
        'type'    : 'button',
  ...
  '108' : {
    ...
    'people'     : 'boy',
    'html'     :
    '<p>... Cherche sur Internet et dis-moi...<br></br>...le nom commun de <b>Balaenoptera physalus</b> est __select__ ...</p>',
    'widgets': [
      {
        'event'   : 'onchange',
        'type'    : 'select',
